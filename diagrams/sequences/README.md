...
- `03_course_catalog_search_modules.wsd` - Course catalog module search
...
- `13_marketplace_create_public_plan.wsd` - Create public plan
- `14_marketplace_delete_public_plan.wsd` - Delete public plan
...
- `19_marketplace_copy_public_plan_into_workspace.wsd` - Copy public plan through existing APIs
